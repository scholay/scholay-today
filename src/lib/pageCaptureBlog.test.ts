...
it("captures the actual ScienceNet blog shape with dates, lazy images and captions but without chrome", () => {
  const dom = new JSDOM(`<title>生态研究 - 作者的博文</title><nav>999</nav><div class="vw mbm">
    ...
    <div id="blog_article"><p>20 个群落，185 种植物，阈值 0.8。</p><p><img src="/grey.gif" data-original="https://example.org/figure.png" alt="图2"></p><p>图2 叶脉性状。基金 32271611、2024YFF1306501。</p>
